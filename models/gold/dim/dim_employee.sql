...
CREATE TABLE gold.finance.dim_employee (
...
-- Insert all employee data with business enhancements
INSERT INTO gold.finance.dim_employee (
  employee_key,
  employee_id,
  email,
  name,
...
WITH employee_dates AS (
  ...
  SELECT
    ...
    hd.date_actual AS hire_date,
    td.date_actual AS termination_date,
    -- Extract attributes from date dimension
    hd.year_actual AS hire_year,
    hd.month_actual AS hire_month,
    hd.quarter_actual AS hire_quarter,
    td.year_actual AS termination_year,
    td.month_actual AS termination_month,
    td.quarter_actual AS termination_quarter
...
-- Insert 'Unknown' employee record for handling NULLs
INSERT INTO gold.finance.dim_employee (
  employee_key,
  employee_id,
  email,
